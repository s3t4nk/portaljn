            ...
            <tbody>
                @foreach ($components as $comp)
                    <tr>
                        ...
                        <td>
                            <form method="POST"
                                action="{{ route('hris.employee-salary-component.update', [$employee->id, $comp->id]) }}"
                                class="d-flex">
                                @csrf @method('PUT')
                        ...
                        <td>
                            <form method="POST"
                                action="{{ route('hris.employee-salary-component.destroy', [$employee->id, $comp->id]) }}">
                                @csrf @method('DELETE')
